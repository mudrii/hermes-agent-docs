...
- Messaging docs omitted LINE and Google Chat. First-party setup docs were imported into both `user-guide/messaging/` and the flat `messaging/` mirror.
- Teams docs lacked meeting-summary pipeline and Microsoft Graph webhook pages. Those first-party docs were imported.
...
- Environment-variable references missed Kanban variables, LINE variables, `HERMES_LANGUAGE`, and Browserbase advanced knobs. The reference was refreshed and patched.
- Configuration docs listed only 8 locales. They now list all 16 locales present in source.
