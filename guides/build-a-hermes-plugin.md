...
|------|-----------|-------------------|---------|
| [`pre_tool_call`](/docs/user-guide/features/hooks#pre_tool_call) | Before any tool executes | `tool_name: str, args: dict, task_id: str` | ignored (or veto — see plugin hooks reference) |
...
| [`on_session_finalize`](/docs/user-guide/features/hooks#on_session_finalize) | When a session is permanently finalized (saved/closed) | `session_id: str, model: str, platform: str` | ignored |
| [`on_session_reset`](/docs/user-guide/features/hooks#on_session_reset) | When a session is reset (e.g. `/new`, `hermes memory reset`) | `session_id: str, model: str, platform: str` | ignored |
