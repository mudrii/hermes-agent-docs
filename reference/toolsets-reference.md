...
**Toolset count:** 39 static toolsets defined in `toolsets.py` (20 core, 2 composite, 17 platform). Additional dynamic toolsets (`mcp-<server>`, plugin-provided) are generated at runtime and vary per installation.
