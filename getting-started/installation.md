...
If you want to clone the repo and install from source — for contributing, running from a specific branch, or having full control over the virtual environment — see the [Development Environment Setup](../contributing.md#development-environment-setup) section in the Contributing guide.
