...
Current as of Hermes Agent **v0.11.0** (`v2026.4.23`). No Home Assistant-specific surface changes shipped in v0.9.0–v0.11.0 — the adapter behaves the same as v0.5.0.
