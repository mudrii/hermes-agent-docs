...
See the [Plugins](plugins.md) page for the general plugin system, and [Build a Hermes Plugin](guides/build-a-hermes-plugin.md) to write your own.
...
Bundled plugins are written exactly like any other Hermes plugin — see [Build a Hermes Plugin](guides/build-a-hermes-plugin.md). The only differences are:
